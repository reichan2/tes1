...
export trojanlink="trojan://${user}@${domain}:${xtr}?sni=${domain}#${user}"
...
export patchtls=/rere-trojanwstls
export patchnone=/rere-trojanwsntls
read -p "   Expired (days) : " masaaktif
...
export trojanlink="trojan://${user}@${domain}:80?host=${domain}&security=none&type=ws&path=${patchnone}#${user}";
export trojanlink1="trojan://${user}@${domain}:443?path=$patchtls&security=tls&host=bug.com&type=ws&sni=${domain}#${user}"
export trojanlink2="trojan://${user}@who.int:443?path=wss://who.int$patchtls&security=tls&host=${domain}&type=ws&sni=who.int#${user}"
export trojanlink3="trojan://${user}@onlinepayment.celcom.com.my:443?path=wss://onlinepayment.celcom.com.my$patchtls&security=tls&host=${domain}&type=ws&sni=onlinepayment.celcom.com.my#${user}"
...
export trojanlink="trojan://${user}@${domain}:80?path=$patchnone&security=none&host=${domain}&type=ws#${user}"
export trojanlink1="trojan://${user}@${domain}:443?path=$patchtls&security=tls&host=bug.com&type=ws&sni=#${user}"
export trojanlink2="trojan://${user}@who.int:443?path=wss://who.int$patchtls&security=tls&host=${domain}&type=ws&sni=who.int#${user}"
export trojanlink3="trojan://${user}@onlinepayment.celcom.com.my:443?path=wss://onlinepayment.celcom.com.my$patchtls&security=tls&host=${domain}&type=ws&sni=onlinepayment.celcom.com.my#${user}"
...
echo -e "\033[1;93m└─────────────────────────────────────────────────┘\033[0m"
echo -e " [\e[36m•01\e[0m] Create Trojan TCP         [\e[36m•06\e[0m] Create Trojan WS"
echo -e " [\e[36m•02\e[0m] Trial Trojan TCP          [\e[36m•07\e[0m] Trial Trojan WS"
echo -e " [\e[36m•03\e[0m] Renew Trojan TCP          [\e[36m•08\e[0m] Renew Trojan WS"
echo -e " [\e[36m•04\e[0m] Dellete Trojan TCP        [\e[36m•09\e[0m] Dellete Trojan WS"
echo -e " [\e[36m•05\e[0m] Cek User Trojan TCP       [\e[36m•10\e[0m] Cek User Trojan WS"
echo -e ""
